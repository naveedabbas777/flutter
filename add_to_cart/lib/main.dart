...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Order My Snacks'), centerTitle: true),
...
class ConfirmationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Confirm Your Order'), centerTitle: true),
      body: GradientBackground(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
                  ...
                  showDialog(
                    ...
                    builder:
                        (context) => AlertDialog(
                          ...
                          content: Text(
                            'Thank you, $name. Your snacks are on the way!',
                          ),
                          actions: [
                            TextButton(
                              child: Text('OK'),
